...
public class SecondDegreeEquation {
    public static void main(String[] arg){
        ...
        sa = JOptionPane.showInputDialog(null, "The number a is:","Enter Value",JOptionPane.INFORMATION_MESSAGE);
        sb = JOptionPane.showInputDialog(null, "The number b is:","Enter Value",JOptionPane.INFORMATION_MESSAGE);
        sc = JOptionPane.showInputDialog(null, "The number c is:","Enter Value",JOptionPane.INFORMATION_MESSAGE);
